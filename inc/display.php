...
class Post {
	...
	public function link($pre = '', $page = false) {
		...
		return $this->root . $board['dir'] . $config['dir']['res'] . sprintf(($page ? $page : $config['file_page']), $this->thread) . '#' . $pre . $this->id_for_board;
	}
...
class Thread {
	...
	public function link($pre = '', $page = false) {
		...
		return $this->root . $board['dir'] . $config['dir']['res'] . sprintf(($page ? $page : $config['file_page']), $this->id_for_board) . '#' . $pre . $this->id_for_board;
	}
