...
$(document).ready(function(){
	...
	// Add an update link
	$('.boardlist.bottom').prev().after("<span id='auto_update'><a href='#' id='update_thread' style='padding-left:10px'>["+_("Update")+"]</a> (<input type='checkbox' id='auto_update_status' checked> Auto) <span id='update_secs'></span></span>");
